...
public class LLWRBACac {
	private final String[] roleVector;
	private Element a_0;
	private Element a_1;
	private Element[] b;
	
	public LLWRBACac(LLWRBACpp pp, LLWRBACmsk msk, String[] roleVector){
		...
		//compute b
		if (pp.getType() == LLWRBACType.CPASecure){
	...
	public LLWRBACac(LLWRBACpp pp, LLWRBACmsk msk, String[] roleVector, LLWRBACiac iac){
		int index[] = new int[roleVector.length];
		this.roleVector = roleVector;
		//compute a_0
	...
	public LLWRBACac(LLWRBACpp pp, LLWRBACac ac, String role){
	...
	public LLWRBACac(LLWRBACpp pp, LLWRBACac ac, String role, LLWRBACiac iac){
		this.roleVector = new String[ac.get_role_vector().length + 1];
		System.arraycopy(ac.get_role_vector(), 0, this.roleVector, 0, ac.get_role_vector().length);
		this.roleVector[ac.get_role_vector().length] = role;
		int index[] = new int[this.roleVector.length];
