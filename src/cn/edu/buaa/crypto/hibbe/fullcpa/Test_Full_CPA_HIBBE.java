...
public class Test_Full_CPA_HIBBE {
	...
	public Test_Full_CPA_HIBBE(int D, int N){
		this.max_role = N;
		this.max_depth = D;
		
		this.hibbe = new Full_CPA_HIBBE();
	...
	private void test_setup_one_round(){
		...
		for (int i=0; i<this.max_role; i++){
			timer.start(i);
			Full_CPA_HIBBE setupRBAC = new Full_CPA_HIBBE();
...
//		out.println();
	...
	public static void main(String[] args){
		new Test_Full_CPA_HIBBE(10, 100).testBenchmark(100);
	}
}
