...
public class Test_SS_CCA_HIBBE {
	...
	public Test_SS_CCA_HIBBE(int D, int N){
		this.max_role = N;
		this.max_depth = D;
		
		this.hibbe = new SS_CCA_HIBBE();
	...
	private void test_setup_one_round(){
		...
		for (int i=0; i<this.max_role; i++){
			timer.start(i);
			SS_CCA_HIBBE setupRBAC = new SS_CCA_HIBBE();
...
//		out.println();
	...
	public static void main(String[] args){
		new Test_SS_CCA_HIBBE(10, 50).testBenchmark(100);
	}
}
